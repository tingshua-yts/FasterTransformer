...
def _create_model_training_args_for_checkpoint_version_0(args, model_00):
    ...
    # hidden size从world Embedding中获取
    model_training_args.hidden_size = model_00["model"]["language_model"]["embedding"]["word_embeddings"]["weight"].shape[1]
...
def convert_checkpoint(args):
    ...
    # 保存 pre_decoder_layernorm:1) get param 2) transpose 3) convert to np 4) save
    ...
    try:
        ...
        # bloom相关更改
        config["gpt"]["model_variant"] = "bloom-pre"
        config["gpt"]["layernorm_type"] = "pre_layernorm"
        config["gpt"]["activation_type"] = "Gelu"
        config["gpt"]["has_positional_encoding"] = "False"
        config["gpt"]["has_pre_decoder_layernorm"] = "True"
        config["gpt"]["has_post_decoder_layernorm"] = "True"
        config["gpt"]["use_attention_linear_bias"] = "True"
